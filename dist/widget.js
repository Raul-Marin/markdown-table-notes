  ...
  while (i < lines.length) {
    ...
    if (line.indexOf("|") !== -1 && i + 1 < lines.length) {
      ...
      if (/^\|?[\s-:|]+\|?$/.test(nextLine) && nextLine.indexOf("-") !== -1) {
        ...
        blocks.push({ t: "table", header: headerCells, rows });
        continue;
      }
    }
    ...
    if (cbMatch) {
      ...
      blocks.push({ t: "cb", x: cbMatch[3], checked, indent });
      i++;
      continue;
    }
...
function PerfectMarkdown() {
  ...
  function cycleWidth() {
    var currentIdx = -1;
    for (var i2 = 0; i2 < WIDTH_CYCLE.length; i2++) {
      if (WIDTH_CYCLE[i2] === w) {
        currentIdx = i2;
        break;
      }
  ...
  for (var i = 0; i < blocks.length; i++) {
    ...
    if (b.t === "h") {
      ...
      for (var hi = 0; hi < hInlineEls.length; hi++) {
        ...
        if (hEl.t === "code") {
          ...
          hChildren.push(h(Text, { key: "hl" + hi, fontSize: fs, fontWeight: 700, fill: theme.link, textDecoration: "underline", onClick: /* @__PURE__ */ function(url) {
            return function() {
              return new Promise(function(resolve) {
    ...
    if (b.t === "li") {
      ...
      for (var li = 0; li < liInlineEls.length; li++) {
        ...
        if (liEl.t === "bold") {
          ...
          liChildren.push(h(Text, { key: "lil" + li, fontSize: 14, fill: theme.link, textDecoration: "underline", onClick: /* @__PURE__ */ function(url) {
            return function() {
              return new Promise(function(resolve) {
                figma.openExternal(url);
                resolve();
    ...
    if (b.t === "ol") {
      ...
      for (var oli = 0; oli < olInlineEls.length; oli++) {
        ...
        if (olEl.t === "bold") {
          ...
          olChildren.push(h(Text, { key: "oll" + oli, fontSize: 14, fill: theme.link, textDecoration: "underline", onClick: /* @__PURE__ */ function(url) {
            return function() {
              return new Promise(function(resolve) {
                figma.openExternal(url);
                resolve();
    ...
    if (b.t === "cb") {
      ...
      var checkboxIcon = b.checked ? h(AutoLayout, {
        width: 16,
        height: 16,
        ...
        verticalAlignItems: "center"
      }, h(Text, { fontSize: 12, fill: "#fff", fontWeight: 700 }, "\u2713")) : h(AutoLayout, {
        width: 16,
        height: 16,
      ...
      for (var cbi = 0; cbi < cbInlineEls.length; cbi++) {
        ...
        if (cbEl.t === "bold") {
          ...
          cbChildren.push(h(Text, { key: "cbl" + cbi, fontSize: 14, fill: theme.link, textDecoration: "underline", onClick: /* @__PURE__ */ function(url) {
            return function() {
              return new Promise(function(resolve) {
                figma.openExternal(url);
                resolve();
      ...
      children.push(
        h(
          ...
          h(
            ...
            h(Text, { fontSize: 12, fill: theme.textMuted }, "\u{1F5BC} " + (b.alt || "Image") + " (" + b.url + ")")
          ),
    ...
    if (b.t === "hr") {
      children.push(
        h(
          AutoLayout,
          { key: "r" + i, width: cw, padding: { top: 12, bottom: 12 } },
    ...
    if (b.t === "code") {
      ...
      children.push(
        h(
          AutoLayout,
          { key: "c" + i, width: cw, padding: { top: 8, bottom: 16 } },
          h(AutoLayout, {
            direction: "vertical",
            width: cw,
            padding: 16,
    ...
    if (b.t === "table") {
        ...
        for (var tci = 0; tci < row.length; tci++) {
          ...
          for (var tdj = 0; tdj < tdInlineEls.length; tdj++) {
            ...
            if (tdEl.t === "bold") {
              ...
              tdChildren.push(h(Text, { key: "tdl" + tdj, fontSize: 14, fill: theme.link, textDecoration: "underline", onClick: /* @__PURE__ */ function(url) {
                return function() {
                  return new Promise(function(resolve) {
                    figma.openExternal(url);
                    resolve();
      ...
      children.push(
        h(
          AutoLayout,
          { key: "tbl" + i, direction: "vertical", width: cw, padding: { top: 8, bottom: 16 } },
          h(AutoLayout, {
            direction: "vertical",
            width: cw,
            cornerRadius: 6,
